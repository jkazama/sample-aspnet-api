...
namespace Sample.Models.Asset
{
    public class CashInOutTest : EntityTestSupport
    {
        ...
        public void Find()
        {
            ...
            Assert.Single(CashInOut.Find(rep, FindParam(baseDay, basePlus1Day)));
            Assert.Single(CashInOut.Find(rep, FindParam(baseDay, basePlus1Day, ActionStatusType.Unprocessed)));
            Assert.Empty(CashInOut.Find(rep, FindParam(baseDay, basePlus1Day, ActionStatusType.Processed)));
            Assert.Empty(CashInOut.Find(rep, FindParam(basePlus1Day, basePlus2Day, ActionStatusType.Unprocessed)));
        }
